                        ...
                        <div className="flex justify-between items-center mb-12 relative px-4 select-none">
                            ...
                            {[1, 2, 3].map((s) => (
                                ...
                                >
                                    ...
                                    <span className={`text-xs font-bold uppercase tracking-wider mt-2 transition-colors duration-300 ${step >= s ? 'text-teal-600' : 'text-slate-300 group-hover:text-teal-400'}`}>
